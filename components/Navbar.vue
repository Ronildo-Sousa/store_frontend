      ...
      <div class="flex md:order-2">
        ...
        <div id="dark-toggle" class="flex ml-2 item-center">
          <button
            id="theme-toggle"
            type="button"
            class="p-2 text-xs text-gray-500 rounded dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700"
          >
            <svg
