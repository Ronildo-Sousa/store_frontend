  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
      ...
      <div class="flex md:order-2">
        ...
        <div class="relative hidden w-[450px] md:block">
          <div
        ...
        <div id="dark-toggle" class="flex ml-2 item-center">
          <button id="theme-toggle" type="button" class="p-2 text-xs text-gray-500 rounded dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700">
